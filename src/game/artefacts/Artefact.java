...
public class Artefact implements IArtefact {
	...
	public Artefact(String type, int attaque, int defense, int magieMin, int magieMax, int puissanceMagie, int connaissance, int moral, int chance, int experience, int ptDeplacement) {
		this.type = type;
